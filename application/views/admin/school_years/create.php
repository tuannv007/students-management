            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <input value="<?php echo set_value('label'); ?>" type="text" name="label" class="form-control">
                        <span class="help-block">
                            <span class="text-danger">
                    ...
                    <div class="form-group">
                        ...
                        <input value="<?php echo set_value('start_year'); ?>" type="text" name="start_year" class="form-control">
                        <span class="help-block">
                            <span class="text-danger">
                    ...
                    <div class="form-group">
                        ...
                        <input value="<?php echo set_value('end_year'); ?>" type="text" name="end_year" class="form-control">
                        <span class="help-block">
                            <span class="text-danger">
