            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <select name="class_id" class="form-control input-sm">
                            <?php foreach ($classes as $class): ?>
                                <?php $selected = $class['id'] == $this->input->post('class_id') || $class['id'] == $student['class_id'] ? 'selected' : ''; ?>
                    ...
                    <div class="form-group">
                        ...
                        <input value="<?php echo set_value('code', $student['code']); ?>" type="text" name="code" class="form-control">
                        <span class="help-block">
                            <span class="text-danger">
                    ...
                    <div class="form-group">
                        ...
                        <input value="<?php echo set_value('name', $student['name']); ?>" type="text" name="name" class="form-control">
                        <span class="help-block">
                            <span class="text-danger">
                    ...
                    <div class="form-group">
                        ...
                        <input value="<?php echo set_value('birthday', $student['birthday']); ?>" type="date" name="birthday" class="form-control">
                        <span class="help-block">
                            <span class="text-danger">
                    ...
                    <div class="form-group">
                        ...
                        <select name="gender" class="form-control">
                            <?php if ($this->input->post('gender') || $student['gender']): ?>
                    ...
                    <div class="form-group">
                        ...
                        <input value="<?php echo set_value('email', $student['email']); ?>" type="text" name="email" class="form-control">
                        <span class="help-block">
                            <span class="text-danger">
                    ...
                    <div class="form-group">
                        ...
                        <input value="<?php echo set_value('phone', $student['phone']); ?>" type="text" name="phone" class="form-control">
                        <span class="help-block">
                            <span class="text-danger">
                    ...
                    <div class="form-group">
                        ...
                        <input value="<?php echo set_value('address', $student['address']); ?>" type="text" name="address" class="form-control">
                        <span class="help-block">
                            <span class="text-danger">
