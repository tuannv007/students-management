            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <input value="<?php echo set_value('code', $department['code']); ?>" type="text" name="code" class="form-control">
                        <span class="help-block">
                            <span class="text-danger">
                    ...
                    <div class="form-group">
                        ...
                        <input value="<?php echo set_value('name', $department['name']); ?>" type="text" name="name" class="form-control">
                        <span class="help-block">
                            <span class="text-danger">
